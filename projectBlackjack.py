...
def checkBlackjack():
    if sum(playerHand) == 21:  #Normal blackjack
            ...
            return True
    elif 11 or 1 in dealerHand and 10 in dealerHand: #Dealer blackjack
...
def checkBust():
    if sum(playerHand) > 21:  #Normal bust
            print("Bust! You lose!")
            return True
    elif sum(dealerHand) > 21:  #Dealer bust
...
def checkWin():
    if sum(dealerHand) > 21: #Dealer bust
            ...
            return True  #Player win other way
